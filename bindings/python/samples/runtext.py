                ...
                while running:
                    ...
                    if 'RAIN' in string:
                        ...
                        if 'pregame' in string[0]:                            
                            ...
                            situation = graphics.DrawText(offscreen_canvas, font, pos + awayLogo.width + buffer + buffer + awayTeam, 10, yellow, situationString)
                            runnerSituation = graphics.DrawText(offscreen_canvas, font, pos + awayLogo.width + buffer + buffer + awayTeam, 25, yellow, runnerSituationString)
                            offscreen_canvas.SetImage(homeLogo, pos + awayLogo.width + buffer + buffer + awayTeam + situation + buffer + buffer + buffer)
                            homeTeam = graphics.DrawText(offscreen_canvas, smallFont, pos + awayLogo.width + buffer + buffer + awayTeam + situation + buffer + buffer + buffer + buffer + homeLogo.width, 10, homeColor, homeTeamString)
                            homeCentered = homeTeam / 2
                            homeTeamStatus = graphics.DrawText(offscreen_canvas, font, pos + awayLogo.width + buffer + buffer + awayTeam + situation + buffer + homeLogo.width + homeCentered, 31, homeColor, homeTeamStatusString)
                            offscreen_canvas.SetImage(pitcherImage,  pos + awayLogo.width + buffer + buffer + awayTeam + situation + buffer + buffer + buffer + buffer + homeLogo.width + homeTeam)
                            pitcherName = graphics.DrawText(offscreen_canvas, smallFont, pos + awayLogo.width + buffer + buffer + awayTeam + situation + buffer + buffer + buffer + buffer + homeLogo.width + homeTeam + pitcherImage.width, 12, white, pitcherNameString)
                            pitcherSummary = graphics.DrawText(offscreen_canvas, smallFont, pos + awayLogo.width + buffer + buffer + awayTeam + situation + buffer + buffer + buffer + buffer + homeLogo.width + homeTeam + pitcherImage.width + pitcherNameString, 26, white, pitcherSummaryString)
                            offscreen_canvas.SetImage(batterImage,  pos + awayLogo.width + buffer + buffer + awayTeam + situation + buffer + buffer + buffer + buffer + homeLogo.width + homeTeam + pitcherImage.width + pitcherNameString)
                            batterName = graphics.DrawText(offscreen_canvas, smallFont, pos + awayLogo.width + buffer + buffer + awayTeam + situation + buffer + buffer + buffer + buffer + homeLogo.width + homeTeam + pitcherImage.width + pitcherNameString + batterImage.width + buffer, 12, white, batterNameString)
                            batterSummary = graphics.DrawText(offscreen_canvas, smallFont, pos + awayLogo.width + buffer + buffer + awayTeam + situation + buffer + buffer + buffer + buffer + homeLogo.width + homeTeam + pitcherImage.width + pitcherNameString + batterImage.width + buffer, 26, white, batterSummaryString)
                            if (pos + awayLogo.width + buffer + buffer + awayTeam + situation + buffer + buffer + buffer + buffer + homeLogo.width + homeTeam + pitcherImage.width + pitcherNameString + batterImage.width + buffer + situation < 0):
                                running = False
                                pos = offscreen_canvas.width
                        else:
