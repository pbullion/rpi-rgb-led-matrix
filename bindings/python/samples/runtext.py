                ...
                while running:
                    ...
                    if 'RAIN' in string:
                        ...
                        if 'pregame' in string[0]:                            
                            ...
                            awayTeam = graphics.DrawText(offscreen_canvas, smallFont, pos + awayLogo.width + buffer, 10, awayColor, awayTeamString)
                            awayCentered = awayTeam / 2
                            awayTeamStatus = graphics.DrawText(offscreen_canvas, font, pos + awayLogo.width + buffer + awayCentered, 26, awayColor, awayTeamStatusString)
                            ...
                            homeCentered = homeTeam / 2
                            homeTeamStatus = graphics.DrawText(offscreen_canvas, font, pos + awayLogo.width + buffer + buffer + awayTeam + status + buffer + homeLogo.width + homeCentered, 26, homeColor, homeTeamStatusString)
