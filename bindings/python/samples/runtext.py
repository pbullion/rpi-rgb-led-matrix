                ...
                while running:
                    ...
                    if 'RAIN' in string:
                        ...
                        if 'pregame' in string[0]:                            
                            ...
                            offscreen_canvas.SetImage(homeLogo, pos + awayLogo.width + buffer + buffer + awayTeam + quarter)
                            homeTeam = graphics.DrawText(offscreen_canvas, smallFont, pos + awayLogo.width + buffer + buffer + awayTeam + quarter + buffer + homeLogo.width, 10, homeColor, homeTeamString)
                        ...
                        if (pos + awayLogo.width + buffer + buffer + awayTeam + quarter + buffer + homeLogo.width + homeTeam + buffer + quarter < 0):
                            running = False
                            pos = offscreen_canvas.width
                        time.sleep(0.01)
                    # elif isinstance(string, list) and 'game' in string[0]:
                    ...
                    #     time.sleep(0.01)
                        ...
                        color = blue
                        espnLogo = Image.open(requests.get('https://i.pinimg.com/564x/b3/69/c7/b369c7454adc03bfea8c6b2f4268be5a.jpg', stream=True).raw).convert('RGB').resize((32,32), Image.ANTIALIAS)
                        pos -= 1
