                ...
                while running:
                    ...
                    if 'RAIN' in string:
                        ...
                        if 'pregame' in string[0]:                            
                            offscreen_canvas.SetImage(awayLogo, pos, -16)
                            versus = graphics.DrawText(offscreen_canvas, font, pos + awayLogo.width + buffer, 24, green, versusString)
                            offscreen_canvas.SetImage(homeLogo, pos + awayLogo.width + buffer + versus + buffer, -16)
                            ...
                            offscreen_canvas.SetImage(homeLogo, pos + awayLogo.width + buffer + buffer + buffer + versus, -16)
