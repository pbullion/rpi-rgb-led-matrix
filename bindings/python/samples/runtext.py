            ...
            for string in strings:
                ...
                while running:
                    ...
                    if 'RAIN' in string:
                        ...
                        homeTeamStatus = graphics.DrawText(offscreen_canvas, smallFont, pos + awayLogo.width + buffer + buffer + awayTeam + versus + buffer + homeLogo.width + 10, 22, awayColor, awayTeamStatusString)
