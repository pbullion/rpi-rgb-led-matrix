                ...
                while running:
                    ...
                    if 'RAIN' in string:
                        ...
                        if 'pregame' in string[0]:     
                            ...
                            offscreen_canvas.SetImage(homeLogo, pos + awayLogo.width + buffer + buffer + buffer + versus, -14)
