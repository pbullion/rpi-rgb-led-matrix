                ...
                while running:
                    ...
                    if 'RAIN' in string:
                        ...
                        if 'pregame' in string[0]:                            
                            ...
                            pitcherName = graphics.DrawText(offscreen_canvas, smallFont, pos + awayLogo.width + buffer + buffer + awayTeam + situation + buffer + buffer + buffer + buffer + homeLogo.width + homeTeam + 32, 12, white, pitcherNameString)
                            pitcherSummary = graphics.DrawText(offscreen_canvas, smallFont, pos + awayLogo.width + buffer + buffer + awayTeam + situation + buffer + buffer + buffer + buffer + homeLogo.width + homeTeam + 32 + pitcherNameString, 26, white, pitcherSummaryString)
                            offscreen_canvas.SetImage(batterImage,  pos + awayLogo.width + buffer + buffer + awayTeam + situation + buffer + buffer + buffer + buffer + homeLogo.width + homeTeam + 32 + pitcherNameString)
                            batterName = graphics.DrawText(offscreen_canvas, smallFont, pos + awayLogo.width + buffer + buffer + awayTeam + situation + buffer + buffer + buffer + buffer + homeLogo.width + homeTeam + 32 + pitcherNameString + batterImage.width + buffer, 12, white, batterNameString)
                            batterSummary = graphics.DrawText(offscreen_canvas, smallFont, pos + awayLogo.width + buffer + buffer + awayTeam + situation + buffer + buffer + buffer + buffer + homeLogo.width + homeTeam + 32 + pitcherNameString + batterImage.width + buffer, 26, white, batterSummaryString)
                            if (pos + awayLogo.width + buffer + buffer + awayTeam + situation + buffer + buffer + buffer + buffer + homeLogo.width + homeTeam + 32 + pitcherNameString + batterImage.width + buffer + situation < 0):
                                running = False
                                pos = offscreen_canvas.width
                        else:
