                    ...
                    if isinstance(arr, list) and 'mlb' in arr[0][0]:
                        for game in arr:
                            ...
                            if 'pregame' in game[0]:
                                ...
                                overUnderStr = graphics.DrawText(offscreen_canvas, smallFont, pos + offset + teamLogos[game[5]].width + versus + teamLogos[game[10]].width + buffer + buffer + buffer + buffer + buffer+ + buffer + buffer+ buffer + buffer + homeTeam + homeTeamStatus, 12, green, 'O/U')
