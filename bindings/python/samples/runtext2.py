...
class RunText(SampleBase):
    ...
    def run(self):
        ...
        teamLogos = {
                ...
                'Miami Marlins': Image.open(requests.get('https://a.espncdn.com/i/teamlogos/mlb/500/scoreboard/mia.png', stream=True).raw).convert('RGB').resize((50,50), Image.ANTIALIAS),
