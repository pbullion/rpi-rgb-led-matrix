            ...
            for arr in responseArr:
                ...
                while running:
                    ...
                    if isinstance(arr, list) and 'mlb' in arr[0]:
                        ...
                        versus = graphics.DrawText(offscreen_canvas, smallFont, 350, 12, green, arr[1])
                        ...
                        versus = graphics.DrawText(offscreen_canvas, smallFont, 280, 12, green, arr[1])
                        versus = graphics.DrawText(offscreen_canvas, smallFont, 420, 12, green, arr[2])
