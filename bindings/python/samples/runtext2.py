...
class RunText(SampleBase):
    ...
    def run(self):
        ...
        while True:
            ...
            responseArr = [False, False, ['rssFeed', 'ESPNTOPSTORIES', "All-Star Home Run Derby tracker: Results, bracket and live updates from Dodger Stadium • Sources: Big 12, Pac-12 won't partner, talks end • All-Star Game decided by HR derby if tied after 9"], ['rssFeed', 'ESPNGOLF', "Way-too-early 2023 golf major championship winners • How Cameron Smith surged at St. Andrews and stole the show from Rory McIlroy at The Open • Cameron Smith's breakthrough, Rory's disappointment and more from an epic Open at St. Andrews"], ['rssFeed', 'CNN', "Matthew Pottinger served on former President's National Security Council before resigning in the immediate aftermath of the 2021 insurrection • Jury nearly seated in Bannon trial over failure to comply with Jan. 6 committee subpoenas  • The January 6 committee is returning to primetime. Here's what you need to know."], '8==================D', ['stocks', [['https://logo.clearbit.com/originbank.com', 'OBNK', '39.69', '0.38%', 'OBNK 39.69 +0.38%', 'up'], ['https://logo.clearbit.com/twitter.com', 'TWTR', '38.41', '1.78%', 'TWTR 38.41 +1.78%', 'up'], ['https://logo.clearbit.com/tesla.com', 'TSLA', '721.64', '0.20%', 'TSLA 721.64 +0.20%', 'up'], ['https://logo.clearbit.com/dowjones.com', 'DOW', '31,072.61', '-215.65', 'Dow 31,072.61 -215.65', 'down'], ['https://logo.clearbit.com/nasdaq.com', 'NASDAQ', '11,360.05', '-92.37', 'NASDAQ 11,360.05 -92.37', 'down']]]]
            ...
            # responseArr = [[['game inProgress mlb', 'https://loodibee.com/wp-content/uploads/mlb-chicago-white-sox-logo.png', 27, 21, 22, 'Chicago White Sox', 'https://loodibee.com/wp-content/uploads/mlb-los-angeles-angels-logo.png', 165, 0, 23, 'Los Angeles Angels', 'Bot 2nd', '0', '0', 'Bottom 2nd', 'Runner on 1st', 'https://a.espncdn.com/i/headshots/mlb/players/full/32697.png', 'L. Giolito • 1.1 IP, 0 ER, 2 H, K, 0 BB', 'https://a.espncdn.com/i/headshots/mlb/players/full/30429.png', 'M. Stassi • 0-0', 'Bot 2nd', '0-1', 3, 'chicago-white-sox', 'los-angeles-angels'], ['game pregame mlb', 'https://loodibee.com/wp-content/uploads/mlb-baltimore-orioles-logo-bird.png', 32, 27, 27, 'Baltimore Orioles', 'https://loodibee.com/wp-content/uploads/mlb-seattle-mariners-logo.png', 1, 42, 91, 'Seattle Mariners', '10:10 PM EDT', '34-40', '34-40', '', '+130', '-154', 'O/U 7.5', 'T. Wells 5-4 3.34', 'G. Kirby 2-2 3.12']], '', '', '']
