...
class RunText(SampleBase):
    ...
    def run(self):
        teamLogos = {
                ...
                'Detroit Tigers': Image.open(requests.get('https://www.nicepng.com/png/detail/142-1429926_detroit-tigers-detroit-tigers-tiger-logo.png', stream=True).raw).convert('RGB').resize((50,50), Image.ANTIALIAS),
