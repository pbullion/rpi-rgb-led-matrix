                    ...
                    if isinstance(arr, list) and 'mlb' in arr[0][0]:
                        for game in arr:
                            ...
                            if 'inProgress' in game[0]:
                                ...
                                for out in outs:
                                    graphics.DrawLine(offscreen_canvas, pos + offset + runningTotal + out[0], out[1] + 4, pos + offset + runningTotal + out[0], out[1], red)
                                    graphics.DrawLine(offscreen_canvas, pos + offset + runningTotal + out[0], out[1] + 4, pos + offset + runningTotal + out[0] + outsSize, out[1], red)
                                    graphics.DrawLine(offscreen_canvas, pos + offset + runningTotal + out[0], out[1] + 4+ outsSize, pos + offset + runningTotal + out[0], out[1], red)
                                    graphics.DrawLine(offscreen_canvas, pos + offset + runningTotal + out[0], out[1] + 4+ outsSize, pos + offset + runningTotal + out[0] + outsSize, out[1], red)
