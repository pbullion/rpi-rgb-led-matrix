                    ...
                    if isinstance(arr, list):
                        for game in arr:
                            ...
                            if 'pregame' in game[0]: 
                                ...
                                versus = graphics.DrawText(offscreen_canvas, middleFont, pos + offset + teamLogos[game[5]].width, 24, green, 'vs')
                                offscreen_canvas.SetImage(teamLogos[game[10]], pos + offset + teamLogos[game[5]].width + buffer + buffer + buffer + buffer, -10)
