...
class RunText(SampleBase):
    ...
    def run(self):
        ...
        while True:
            ...
            responseArr = [['rssFeed', 'ESPNTOPSTORIES', "All-Star Home Run Derby tracker: Results, bracket and live updates from Dodger Stadium • Power of 2: MLB's most productive jersey numbers • Sources: Big 12, Pac-12 won't partner, talks end"]]
            # responseArr = [['stocks', [['https://logo.clearbit.com/originbank.com', 'OBNK', '39.69', '0.38%', 'OBNK 39.69 +0.38%', 'up'], ['https://logo.clearbit.com/twitter.com', 'TWTR', '38.41', '1.78%', 'TWTR 38.41 +1.78%', 'up'], ['https://logo.clearbit.com/tesla.com', 'TSLA', '721.64', '0.20%', 'TSLA 721.64 +0.20%', 'up'], ['https://logo.clearbit.com/dowjones.com', 'DOW', '31,072.61', '-215.65', 'Dow 31,072.61 -215.65', 'down'], ['https://logo.clearbit.com/nasdaq.com', 'NASDAQ', '11,360.05', '-92.37', 'NASDAQ 11,360.05 -92.37', 'down']]]]
            ...
            for arr in responseArr:
                ...
                while running:
                    ...
                    #     time.sleep(0.025)
                        ...
                        length = graphics.DrawText(offscreen_canvas, alilbiggerFont, pos, 26, green, arr[2])
                        pos -= 1
                        if (pos + length < 0):
                            running = False
                            pos = offscreen_canvas.width
