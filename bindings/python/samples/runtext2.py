                            ...
                            if 'inProgress' in game[0]:
                                ...
                                if outsString == 1:
                                    ...
                                    for y_offset in range(size):
                                        graphics.DrawLine(offscreen_canvas, pos + offset + runningTotal + outs[0][0], outs[0][1] - y_offset, pos + runningTotal + offset + outs[0][0] + outsSize, outs[0][1] + size -y_offset, green)
