...
class RunText(SampleBase):
    ...
    def run(self):
        teamLogos = {
                ...
                'NHL': Image.open(requests.get('https://en.wikipedia.org/wiki/National_Hockey_League#/media/File:05_NHL_Shield.svg', stream=True).raw).convert('RGB').resize((50,50), Image.ANTIALIAS),
