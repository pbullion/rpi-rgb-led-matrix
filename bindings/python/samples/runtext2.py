...
class RunText(SampleBase):
    ...
    def run(self):
        teamLogos = {
                'MLB': Image.open(requests.get('https://loodibee.com/wp-content/uploads/Major_League_Baseball_MLB_transparent_logo.png', stream=True).raw).convert('RGBA').resize((50,50), Image.ANTIALIAS),
                # 'NFL': Image.open(requests.get('https://loodibee.com/wp-content/uploads/nfl-league-logo.png', stream=True).raw).convert('RGBA').resize((50,50), Image.ANTIALIAS),
                # 'NHL': Image.open(requests.get('https://loodibee.com/wp-content/uploads/Major_League_Baseball_MLB_transparent_logo.png', stream=True).raw).convert('RGBA').resize((50,50), Image.ANTIALIAS),
                # 'NHL': Image.open(requests.get('https://upload.wikimedia.org/wikipedia/en/3/3a/05_NHL_Shield.svg', stream=True).raw).convert('RGBA').resize((50,50), Image.ANTIALIAS),
                # 'Tampa Bay Lightning': Image.open(requests.get('https://loodibee.com/wp-content/uploads/nhl-tampa-bay-lightning-logo.png', stream=True).raw).convert('RGBA').resize((50,50), Image.ANTIALIAS),
                # 'Colorado Avalanche': Image.open(requests.get('https://loodibee.com/wp-content/uploads/nhl-colorado-avalanche-logo.png', stream=True).raw).convert('RGBA').resize((50,50), Image.ANTIALIAS),
                'New York Yankees': Image.open(requests.get('https://loodibee.com/wp-content/uploads/mlb-new-york-yankees-logo.png', stream=True).raw).convert('RGBA').resize((50,50), Image.ANTIALIAS),
                'Washington Nationals': Image.open(requests.get('https://loodibee.com/wp-content/uploads/mlb-washington-nationals-logo.png', stream=True).raw).convert('RGBA').resize((50,50), Image.ANTIALIAS),
                'Texas Rangers': Image.open(requests.get('https://loodibee.com/wp-content/uploads/mlb-texas-rangers-logo.png', stream=True).raw).convert('RGBA').resize((50,50), Image.ANTIALIAS),
                'New York Mets': Image.open(requests.get('https://loodibee.com/wp-content/uploads/mlb-new-york-mets-logo.png', stream=True).raw).convert('RGBA').resize((50,50), Image.ANTIALIAS),
                'Miami Marlins': Image.open(requests.get('https://loodibee.com/wp-content/uploads/mlb-miami-marlins-logo.png', stream=True).raw).convert('RGBA').resize((50,50), Image.ANTIALIAS),
                'Oakland Athletics': Image.open(requests.get('https://loodibee.com/wp-content/uploads/mlb-oakland-athletics-logo.png', stream=True).raw).convert('RGBA').resize((50,50), Image.ANTIALIAS),
                'Kansas City Royals': Image.open(requests.get('https://loodibee.com/wp-content/uploads/mlb-kansas-city-royals-logo.png', stream=True).raw).convert('RGBA').resize((50,50), Image.ANTIALIAS),
                'Toronto Blue Jays': Image.open(requests.get('https://loodibee.com/wp-content/uploads/mlb-toronto-blue-jays-logo.png', stream=True).raw).convert('RGBA').resize((50,50), Image.ANTIALIAS),
                'Milwaukee Brewers': Image.open(requests.get('https://loodibee.com/wp-content/uploads/mlb-milwaukee-brewers-logo.png', stream=True).raw).convert('RGBA').resize((50,50), Image.ANTIALIAS),
                'Boston Red Sox': Image.open(requests.get('https://loodibee.com/wp-content/uploads/mlb-boston-red-sox-logo.png', stream=True).raw).convert('RGBA').resize((50,50), Image.ANTIALIAS),
                'Cleveland Guardians': Image.open(requests.get('https://loodibee.com/wp-content/uploads/mlb-cleveland-guardians-logo.png', stream=True).raw).convert('RGBA').resize((50,50), Image.ANTIALIAS),
                'Cincinnati Reds': Image.open(requests.get('https://loodibee.com/wp-content/uploads/mlb-cincinnati-reds-logo.png', stream=True).raw).convert('RGBA').resize((50,50), Image.ANTIALIAS),
                'San Francisco Giants': Image.open(requests.get('https://loodibee.com/wp-content/uploads/mlb-san-francisco-giants-logo.png', stream=True).raw).convert('RGBA').resize((50,50), Image.ANTIALIAS),
                'Colorado Rockies': Image.open(requests.get('https://loodibee.com/wp-content/uploads/mlb-colorado-rockies-logo.png', stream=True).raw).convert('RGBA').resize((50,50), Image.ANTIALIAS),
                'Minnesota Twins': Image.open(requests.get('https://loodibee.com/wp-content/uploads/mlb-minnesota-twins-logo.png', stream=True).raw).convert('RGBA').resize((50,50), Image.ANTIALIAS),
                'Los Angeles Dodgers': Image.open(requests.get('https://loodibee.com/wp-content/uploads/mlb-los-angeles-dodgers-logo.png', stream=True).raw).convert('RGBA').resize((50,50), Image.ANTIALIAS),
                'Atlanta Braves': Image.open(requests.get('https://loodibee.com/wp-content/uploads/mlb-atlanta-braves-logo.png', stream=True).raw).convert('RGBA').resize((50,50), Image.ANTIALIAS),
                'Seattle Mariners': Image.open(requests.get('https://loodibee.com/wp-content/uploads/mlb-seattle-mariners-logo.png', stream=True).raw).convert('RGBA').resize((50,50), Image.ANTIALIAS),
                'Los Angeles Angels': Image.open(requests.get('https://loodibee.com/wp-content/uploads/mlb-los-angeles-angels-logo.png', stream=True).raw).convert('RGBA').resize((50,50), Image.ANTIALIAS),
                'Detroit Tigers': Image.open(requests.get('https://loodibee.com/wp-content/uploads/mlb-detroit-tigers-logo.png', stream=True).raw).convert('RGBA').resize((50,50), Image.ANTIALIAS),
                'Arizona Diamondbacks': Image.open(requests.get('https://loodibee.com/wp-content/uploads/mlb-arizona-diamondbacks-logo.png', stream=True).raw).convert('RGBA').resize((50,50), Image.ANTIALIAS),
                'Philadelphia Phillies': Image.open(requests.get('https://loodibee.com/wp-content/uploads/mlb-philadelphia-phillies-logo.png', stream=True).raw).convert('RGBA').resize((50,50), Image.ANTIALIAS),
                'San Diego Padres': Image.open(requests.get('https://s.yimg.com/cv/apiv2/default/mlb/20200508/500x500/padres_wbgs.png', stream=True).raw).convert('RGBA').resize((50,50), Image.ANTIALIAS),
                'Pittsburgh Pirates': Image.open(requests.get('https://loodibee.com/wp-content/uploads/mlb-pittsburgh-pirates-logo.png', stream=True).raw).convert('RGBA').resize((50,50), Image.ANTIALIAS),
                'Tampa Bay Rays': Image.open(requests.get('https://loodibee.com/wp-content/uploads/mlb-tampa-bay-rays-logo.png', stream=True).raw).convert('RGBA').resize((50,50), Image.ANTIALIAS),
                'Baltimore Orioles': Image.open(requests.get('https://loodibee.com/wp-content/uploads/mlb-baltimore-orioles-logo-bird.png', stream=True).raw).convert('RGBA').resize((50,50), Image.ANTIALIAS),
                'Chicago White Sox': Image.open(requests.get('https://loodibee.com/wp-content/uploads/mlb-chicago-white-sox-logo.png', stream=True).raw).convert('RGBA').resize((50,50), Image.ANTIALIAS),
                'St. Louis Cardinals': Image.open(requests.get('https://loodibee.com/wp-content/uploads/mlb-st-louis-cardinals-logo.png', stream=True).raw).convert('RGBA').resize((50,50), Image.ANTIALIAS),
                'Chicago Cubs': Image.open(requests.get('https://loodibee.com/wp-content/uploads/mlb-chicago-cubs-logo.png', stream=True).raw).convert('RGBA').resize((50,50), Image.ANTIALIAS),
                'Houston Astros': Image.open(requests.get('https://loodibee.com/wp-content/uploads/mlb-houston-astros-logo.png', stream=True).raw).convert('RGBA').resize((50,50), Image.ANTIALIAS),
            }
        while True:
            ...
            responseArr = [[['mlb logo'], ['game pregame mlb', 'https://loodibee.com/wp-content/uploads/mlb-chicago-cubs-logo.png', 250, 250, 250, 'Chicago Cubs', 'https://loodibee.com/wp-content/uploads/mlb-san-francisco-giants-logo.png', 22, 20, 21, 'San Francisco Giants', '6:00', '41-59', '50-51', '', '+152', '-180', '7.5', 'A. Sampson 0-1 3.20', 'C. Rodon 8-6 3.18']], ['golf', 'Rocket Mortgage Classic', 'Complete', '1. Tony Finau -26 • T2. Patrick Cantlay -21 • T2. Cameron Young -21 • T2. Taylor Pendrith -21 • 5. Stephan Jaeger -20 • 6. Taylor Moore -19 • 7. Joohyung Kim -18 • T8. Wyndham Clark -17 • T8. J.J. Spaun -17 • T10. Matt Wallace -16 • T10. Charley Hoffman -16 • T10. Russell Henley -16'], '', '', ['rssFeed', 'ESPN TOP NEWS', "Celtics great Russell, 11-time champ, dies at 88 • Kelly inspires England to historic Euro '22 win • Ronaldo exits stadium before Man Utd draw ends"], '', 'MANCAVEDISPLAYS', ['stocks', [['https://logo.clearbit.com/originbank.com', 'OBNK', '43.07', '0.77%', 'OBNK 43.07 +0.77%', 'up'], ['https://logo.clearbit.com/tesla.com', 'TSLA', '891.45', '5.79%', 'TSLA 891.45 +5.79%', 'up'], ['https://logo.clearbit.com/stem.com', 'STEM', '11.33', '5.99%', 'STEM 11.33 +5.99%', 'up'], ['https://logo.clearbit.com/apple.com', 'AAPL', '162.51', '3.28%', 'AAPL 162.51 +3.28%', 'up'], ['https://logo.clearbit.com/dowjones.com', 'DOW', '32,845.13', '315.50', 'Dow 32,845.13 +315.50', 'up'], ['https://logo.clearbit.com/nasdaq.com', 'NASDAQ', '12,390.69', '228.09', 'NASDAQ 12,390.69 +228.09', 'up']]]]
            print(responseArr)
