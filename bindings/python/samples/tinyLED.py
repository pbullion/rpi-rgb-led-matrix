...
class RunText(SampleBase):
    ...
    def run(self):
        while True:
            ...
            responseArr = [{'league': 'nba', 'pregame': True, 'inprogress': False, 'final': False, 'awayTeam': {'teamName': 'Spurs', 'name': 'SA', 'colors': {'main': [182, 191, 191], 'secondary': [0, 0, 0]}, 'record': '16-25'}, 'homeTeam': {'teamName': 'Pelicans', 'name': 'NO', 'colors': {'main': [0, 43, 92], 'secondary': [227, 25, 55]}, 'record': '34-48'}, 'startTime': '9:30 PM EDT', 'weather': {'indoors': True, 'temp': 'undefined°'}, 'fanDuel': {'moneyLine': {'home': {'name': 'New Orleans Pelicans', 'price': -235}, 'away': {'name': 'San Antonio Spurs', 'price': 194}}, 'spread': {'home': {'name': 'New Orleans Pelicans', 'price': -110, 'point': -6}, 'away': {'name': 'San Antonio Spurs', 'price': -110, 'point': 6}}, 'totals': {'over': {'name': 'Over', 'price': -112, 'point': 225}, 'under': {'name': 'Under', 'price': -108, 'point': 225}}}}]
            print(responseArr)
            canvas = self.matrix
