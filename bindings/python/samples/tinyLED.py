...
class RunText(SampleBase):
    ...
    def run(self):
        while True:
            ...
            responseArr = [{'league': 'mlb', 'pregame': False, 'inprogress': False, 'final': True, 'awayTeam': {'teamName': 'Phillies', 'name': 'PHI', 'score': '9', 'hits': {'name': 'hits', 'abbreviation': 'H', 'displayValue': '10'}, 'errors': {'name': 'errors', 'abbreviation': 'E', 'displayValue': '0'}, 'colors': {'main': [190, 0, 17], 'secondary': [40, 72, 152]}, 'record': '8-1'}, 'homeTeam': {'teamName': 'Rays', 'name': 'TB', 'score': '2', 'hits': {'name': 'hits', 'abbreviation': 'H', 'displayValue': '3'}, 'errors': {'name': 'errors', 'abbreviation': 'E', 'displayValue': '0'}, 'colors': {'main': [250, 250, 250], 'secondary': [143, 188, 230]}, 'record': '10-7'}, 'winningPitcher': 'R. Suarez 1-1', 'losingPitcher': 'L. Patino 1-1', 'finalDetail': 'Final'}, {'league': 'nba', 'pregame': False, 'inprogress': False, 'final': True, 'awayTeam': {'teamName': 'Mavericks', 'name': 'DAL', 'score': '131', 'colors': {'main': [12, 71, 157], 'secondary': [196, 206, 211]}, 'record': '27-12'}, 'homeTeam': {'teamName': 'Pistons', 'name': 'DET', 'score': '113', 'colors': {'main': [250, 0, 44], 'secondary': [250, 250, 250]}, 'record': '50-30'}, 'winningPitcher': '', 'losingPitcher': '', 'finalDetail': 'Final'}, {'league': 'nba', 'pregame': False, 'inprogress': False, 'final': True, 'awayTeam': {'teamName': 'Nets', 'name': 'BKN', 'score': '110', 'colors': {'main': [250, 250, 250], 'secondary': [255, 255, 255]}, 'record': '18-21'}, 'homeTeam': {'teamName': 'Knicks', 'name': 'NY', 'score': '98', 'colors': {'main': [34, 94, 168], 'secondary': [245, 132, 38]}, 'record': '42-38'}, 'winningPitcher': '', 'losingPitcher': '', 'finalDetail': 'Final'}, {'league': 'nba', 'pregame': False, 'inprogress': False, 'final': True, 'awayTeam': {'teamName': 'Wizards', 'name': 'WSH', 'score': '103', 'colors': {'main': [14, 55, 100], 'secondary': [227, 24, 55]}, 'record': '21-19'}, 'homeTeam': {'teamName': 'Hawks', 'name': 'ATL', 'score': '118', 'colors': {'main': [250, 250, 250], 'secondary': [250, 250, 250]}, 'record': '35-45'}, 'winningPitcher': '', 'losingPitcher': '', 'finalDetail': 'Final'}, {'league': 'nba', 'pregame': False, 'inprogress': False, 'final': True, 'awayTeam': {'teamName': 'Celtics', 'name': 'BOS', 'score': '117', 'colors': {'main': [250, 250, 250], 'secondary': [241, 242, 243]}, 'record': '28-13'}, 'homeTeam': {'teamName': 'Bulls', 'name': 'CHI', 'score': '94', 'colors': {'main': [250, 250, 250], 'secondary': [250, 250, 250]}, 'record': '50-30'}, 'winningPitcher': '', 'losingPitcher': '', 'finalDetail': 'Final'}, {'league': 'nba', 'pregame': False, 'inprogress': False, 'final': True, 'awayTeam': {'teamName': 'Thunder', 'name': 'OKC', 'score': '101', 'colors': {'main': [198, 124, 3], 'secondary': [240, 81, 51]}, 'record': '12-29'}, 'homeTeam': {'teamName': 'Jazz', 'name': 'UTAH', 'score': '137', 'colors': {'main': [6, 20, 63], 'secondary': [249, 160, 27]}, 'record': '24-56'}, 'winningPitcher': '', 'losingPitcher': '', 'finalDetail': 'Final'}, {'league': 'nba', 'pregame': False, 'inprogress': False, 'final': True, 'awayTeam': {'teamName': 'Suns', 'name': 'PHX', 'score': '109', 'colors': {'main': [35, 0, 106], 'secondary': [241, 242, 243]}, 'record': '32-8'}, 'homeTeam': {'teamName': 'Clippers', 'name': 'LAC', 'score': '113', 'colors': {'main': [250, 0, 40], 'secondary': [241, 242, 243]}, 'record': '63-17'}, 'winningPitcher': '', 'losingPitcher': '', 'finalDetail': 'Final'}]
            print(responseArr)
            canvas = self.matrix
                ...
                if type(item) is dict and 'league' in item.keys() and item['league'] == 'mlb':
                    ...
                    if item['final'] == True:    
                        ...
                        for offset in range(18):
                            graphics.DrawLine(canvas, 0, offset, oddsStartNum - 8, offset, awayColorPrimary)
                        for offset in range(18):
                            graphics.DrawLine(canvas, 0, offset + 18, oddsStartNum - 8, offset + 18, homeColorPrimary)
                        awayTeam = graphics.DrawText(canvas, middleFont, 1, 11, awayColorSecondary, item['awayTeam']['teamName'])
                        homeTeam = graphics.DrawText(canvas, middleFont, 1, 24, homeColorSecondary, item['homeTeam']['teamName'])
                        runningCount = oddsStartNum
                        awayScore = graphics.DrawText(canvas, middleFont, runningCount, 12, green if int(item['awayTeam']['score']) > int(item['homeTeam']['score']) else red, item['awayTeam']['score'])
                        homeScore = graphics.DrawText(canvas, middleFont, runningCount, 23, green if int(item['homeTeam']['score']) > int(item['awayTeam']['score']) else red, item['homeTeam']['score'])
                        runningCount = runningCount + homeScore + 10
