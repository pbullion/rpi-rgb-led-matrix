            ...
            for item in responseArr:
                ...
                if type(item) is dict and 'league' in item.keys() and item['league'] == 'mlb':
                    ...
                    for day in item:
                        ...
                        weatherConditionText = graphics.DrawText(canvas, alilbiggerFont, 0, 20, blue, day['condition'])
                        highLow = graphics.DrawText(canvas, alilbiggerFont, 0, 32, blue, day['highLow'])
                        currentTemp = graphics.DrawText(canvas, alilbiggerFont, 0, 36, blue, day['rainPercent'])
