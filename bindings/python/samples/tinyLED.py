...
class RunText(SampleBase):
    ...
    def run(self):
        while True:
            ...
            responseArr = [{'stockSymbol': 'TSLA', 'url': 'https://logo.clearbit.com/tesla.com', 'currentPrice': '1054.97', 'up': False, 'percentChange': '3.33%'}, {'stockSymbol': 'OBNK', 'url': 'https://logo.clearbit.com/originbank.com', 'currentPrice': '41.41', 'up': True, 'percentChange': '0.24%'}, {'stockSymbol': 'STEM', 'url': 'https://logo.clearbit.com/stem.com', 'currentPrice': '10.72', 'up': False, 'percentChange': '8.53%'}, {'stockSymbol': 'AAPL', 'url': 'https://logo.clearbit.com/apple.com', 'currentPrice': '172.79', 'up': False, 'percentChange': '1.30%'}, {'stockSymbol': 'AMC', 'url': 'https://logo.clearbit.com/amctheatres.com', 'currentPrice': '20.78', 'up': False, 'percentChange': '2.03%'}, {'stockSymbol': 'AMD', 'url': 'https://logo.clearbit.com/amd.com', 'currentPrice': '104.47', 'up': False, 'percentChange': '2.20%'}, {'stockSymbol': 'HOOD', 'url': 'https://logo.clearbit.com/robinhood.com', 'currentPrice': '12.48', 'up': False, 'percentChange': '4.21%'}, {'stockSymbol': 'BTC', 'url': 'https://logo.clearbit.com/bitcoin.org', 'currentPrice': '43807', 'up': False, 'percentChange': '4.14%'}, {'stockSymbol': 'ETH', 'url': 'https://logo.clearbit.com/ethereum.org', 'currentPrice': '3237.99', 'up': False, 'percentChange': '5.60%'}, {'stockSymbol': 'DOGE', 'url': 'https://logo.clearbit.com/dogecoin.com', 'currentPrice': '0.1467', 'up': False, 'percentChange': '10.59%'}, [], {'league': 'nba', 'pregame': True, 'inprogress': False, 'final': False, 'awayTeam': {'teamName': 'Mavericks', 'name': 'DAL', 'colors': {'main': [12, 71, 157], 'secondary': [196, 206, 211]}, 'record': '27-12'}, 'homeTeam': {'teamName': 'Pistons', 'name': 'DET', 'colors': {'main': [250, 0, 44], 'secondary': [250, 250, 250]}, 'record': '49-30'}, 'startTime': '7:00 PM EDT', 'weather': {'indoors': True, 'temp': 'undefined°'}, 'fanDuel': {'moneyLine': {'home': {'name': 'Detroit Pistons', 'price': 310}, 'away': {'name': 'Dallas Mavericks', 'price': -390}}, 'spread': {'home': {'name': 'Detroit Pistons', 'price': -110, 'point': 8.5}, 'away': {'name': 'Dallas Mavericks', 'price': -110, 'point': -8.5}}, 'totals': {'over': {'name': 'Over', 'price': -110, 'point': 218.5}, 'under': {'name': 'Under', 'price': -110, 'point': 218.5}}}}, {'league': 'nba', 'pregame': True, 'inprogress': False, 'final': False, 'awayTeam': {'teamName': 'Nets', 'name': 'BKN', 'colors': {'main': [250, 250, 250], 'secondary': [255, 255, 255]}, 'record': '18-21'}, 'homeTeam': {'teamName': 'Knicks', 'name': 'NY', 'colors': {'main': [34, 94, 168], 'secondary': [245, 132, 38]}, 'record': '41-38'}, 'startTime': '7:30 PM EDT', 'weather': {'indoors': True, 'temp': 'undefined°'}, 'fanDuel': {'moneyLine': {'home': {'name': 'New York Knicks', 'price': 176}, 'away': {'name': 'Brooklyn Nets', 'price': -210}}, 'spread': {'home': {'name': 'New York Knicks', 'price': -110, 'point': 5}, 'away': {'name': 'Brooklyn Nets', 'price': -110, 'point': -5}}, 'totals': {'over': {'name': 'Over', 'price': -110, 'point': 229.5}, 'under': {'name': 'Under', 'price': -110, 'point': 229.5}}}}, {'league': 'nba', 'pregame': True, 'inprogress': False, 'final': False, 'awayTeam': {'teamName': 'Wizards', 'name': 'WSH', 'colors': {'main': [14, 55, 100], 'secondary': [227, 24, 55]}, 'record': '21-19'}, 'homeTeam': {'teamName': 'Hawks', 'name': 'ATL', 'colors': {'main': [250, 250, 250], 'secondary': [250, 250, 250]}, 'record': '35-44'}, 'startTime': '8:00 PM EDT', 'weather': {'indoors': True, 'temp': 'undefined°'}, 'fanDuel': {'moneyLine': {'home': {'name': 'Atlanta Hawks', 'price': -590}, 'away': {'name': 'Washington Wizards', 'price': 410}}, 'spread': {'home': {'name': 'Atlanta Hawks', 'price': -110, 'point': -10.5}, 'away': {'name': 'Washington Wizards', 'price': -110, 'point': 10.5}}, 'totals': {'over': {'name': 'Over', 'price': -110, 'point': 234}, 'under': {'name': 'Under', 'price': -110, 'point': 234}}}}, {'league': 'nba', 'pregame': True, 'inprogress': False, 'final': False, 'awayTeam': {'teamName': 'Celtics', 'name': 'BOS', 'colors': {'main': [250, 250, 250], 'secondary': [241, 242, 243]}, 'record': '28-13'}, 'homeTeam': {'teamName': 'Bulls', 'name': 'CHI', 'colors': {'main': [250, 250, 250], 'secondary': [250, 250, 250]}, 'record': '49-30'}, 'startTime': '8:00 PM EDT', 'weather': {'indoors': True, 'temp': 'undefined°'}, 'fanDuel': {'moneyLine': {'home': {'name': 'Chicago Bulls', 'price': 230}, 'away': {'name': 'Boston Celtics', 'price': -280}}, 'spread': {'home': {'name': 'Chicago Bulls', 'price': -110, 'point': 7}, 'away': {'name': 'Boston Celtics', 'price': -110, 'point': -7}}, 'totals': {'over': {'name': 'Over', 'price': -110, 'point': 224.5}, 'under': {'name': 'Under', 'price': -110, 'point': 224.5}}}}, {'league': 'nba', 'pregame': True, 'inprogress': False, 'final': False, 'awayTeam': {'teamName': 'Thunder', 'name': 'OKC', 'colors': {'main': [198, 124, 3], 'secondary': [240, 81, 51]}, 'record': '12-29'}, 'homeTeam': {'teamName': 'Jazz', 'name': 'UTAH', 'colors': {'main': [6, 20, 63], 'secondary': [249, 160, 27]}, 'record': '24-55'}, 'startTime': '9:00 PM EDT', 'weather': {'indoors': True, 'temp': 'undefined°'}, 'fanDuel': {'moneyLine': {'home': {'name': 'Utah Jazz', 'price': -2200}, 'away': {'name': 'Oklahoma City Thunder', 'price': 1100}}, 'spread': {'home': {'name': 'Utah Jazz', 'price': -110, 'point': -17}, 'away': {'name': 'Oklahoma City Thunder', 'price': -110, 'point': 17}}, 'totals': {'over': {'name': 'Over', 'price': -110, 'point': 219}, 'under': {'name': 'Under', 'price': -110, 'point': 219}}}}, {'league': 'nba', 'pregame': True, 'inprogress': False, 'final': False, 'awayTeam': {'teamName': 'Suns', 'name': 'PHX', 'colors': {'main': [35, 0, 106], 'secondary': [241, 242, 243]}, 'record': '32-8'}, 'homeTeam': {'teamName': 'Clippers', 'name': 'LAC', 'colors': {'main': [250, 0, 40], 'secondary': [241, 242, 243]}, 'record': '63-16'}, 'startTime': '10:00 PM EDT', 'weather': {'indoors': True, 'temp': 'undefined°'}, 'fanDuel': {'moneyLine': {'home': {'price': ''}, 'away': {'price': ''}}, 'spread': {'home': {'price': ''}, 'away': {'price': ''}}, 'totals': {'over': {'price': ''}, 'under': {'price': ''}}}}]
            print(responseArr)
            canvas = self.matrix
