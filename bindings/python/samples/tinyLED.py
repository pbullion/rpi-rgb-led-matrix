        ...
        while True:
            ...
            for item in responseArr:
                ...
                if type(item) is dict and 'league' in item.keys() and item['league'] == 'mlb':
                    ...
                    while running:
                        pos -= 1
                        tourneyName = graphics.DrawText(canvas, smallestFont, 10, 5, blue, item['topGolfers'])
                        if (pos + tourneyName < 0):
                            running = False
