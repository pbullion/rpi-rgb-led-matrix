...
class RunText(SampleBase):
    ...
    def run(self):
        while True:
            ...
            responseArr = [{'league': 'nba', 'pregame': False, 'inprogress': False, 'final': True, 'awayTeam': {'teamName': 'Mavericks', 'name': 'DAL', 'score': '131', 'colors': {'main': [0, 80, 181], 'secondary': [141, 144, 147]}, 'record': '27-12'}, 'homeTeam': {'teamName': 'Pistons', 'name': 'DET', 'score': '113', 'colors': {'main': [0, 80, 181], 'secondary': [141, 144, 147]}, 'record': '50-30'}, 'winningPitcher': '', 'losingPitcher': '', 'finalDetail': 'Final'}, {'league': 'nba', 'pregame': False, 'inprogress': False, 'final': True, 'awayTeam': {'teamName': 'Nets', 'name': 'BKN', 'score': '110', 'colors': {'main': [1, 1, 1], 'secondary': [255, 255, 255]}, 'record': '18-21'}, 'homeTeam': {'teamName': 'Knicks', 'name': 'NY', 'score': '98', 'colors': {'main': [1, 1, 1], 'secondary': [255, 255, 255]}, 'record': '42-38'}, 'winningPitcher': '', 'losingPitcher': '', 'finalDetail': 'Final'}, {'league': 'nba', 'pregame': False, 'inprogress': False, 'final': True, 'awayTeam': {'teamName': 'Wizards', 'name': 'WSH', 'score': '103', 'colors': {'main': [12, 35, 64], 'secondary': [200, 16, 46]}, 'record': '21-19'}, 'homeTeam': {'teamName': 'Hawks', 'name': 'ATL', 'score': '118', 'colors': {'main': [12, 35, 64], 'secondary': [200, 16, 46]}, 'record': '35-45'}, 'winningPitcher': '', 'losingPitcher': '', 'finalDetail': 'Final'}, {'league': 'nba', 'pregame': False, 'inprogress': False, 'final': True, 'awayTeam': {'teamName': 'Celtics', 'name': 'BOS', 'score': '117', 'colors': {'main': [0, 122, 51], 'secondary': [255, 255, 255]}, 'record': '28-13'}, 'homeTeam': {'teamName': 'Bulls', 'name': 'CHI', 'score': '94', 'colors': {'main': [0, 122, 51], 'secondary': [255, 255, 255]}, 'record': '50-30'}, 'winningPitcher': '', 'losingPitcher': '', 'finalDetail': 'Final'}, {'league': 'nba', 'pregame': False, 'inprogress': False, 'final': True, 'awayTeam': {'teamName': 'Thunder', 'name': 'OKC', 'score': '101', 'colors': {'main': [0, 125, 195], 'secondary': [240, 81, 51]}, 'record': '12-29'}, 'homeTeam': {'teamName': 'Jazz', 'name': 'UTAH', 'score': '137', 'colors': {'main': [0, 125, 195], 'secondary': [240, 81, 51]}, 'record': '24-56'}, 'winningPitcher': '', 'losingPitcher': '', 'finalDetail': 'Final'}, {'league': 'nba', 'pregame': False, 'inprogress': False, 'final': True, 'awayTeam': {'teamName': 'Suns', 'name': 'PHX', 'score': '109', 'colors': {'main': [229, 96, 32], 'secondary': [29, 17, 96]}, 'record': '32-8'}, 'homeTeam': {'teamName': 'Clippers', 'name': 'LAC', 'score': '113', 'colors': {'main': [229, 96, 32], 'secondary': [29, 17, 96]}, 'record': '63-17'}, 'winningPitcher': '', 'losingPitcher': '', 'finalDetail': 'Final'}]
            print(responseArr)
            canvas = self.matrix
