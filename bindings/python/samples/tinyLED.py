...
class RunText(SampleBase):
    ...
    def run(self):
        while True:
            ...
            responseArr = [{'league': 'mlb', 'pregame': True, 'inprogress': False, 'final': False, 'awayTeam': {'teamName': 'Mavericks', 'name': 'DAL', 'colors': {'main': [12, 71, 157], 'secondary': [196, 206, 211]}, 'record': '27-12'}, 'homeTeam': {'teamName': 'Pistons', 'name': 'DET', 'colors': {'main': [250, 0, 44], 'secondary': [250, 250, 250]}, 'record': '49-30'}, 'startTime': '7:00 PM EDT', 'weather': {'indoors': True, 'temp': 'undefined°'}, 'fanDuel': {'moneyLine': {'home': {'name': 'Detroit Pistons', 'price': 310}, 'away': {'name': 'Dallas Mavericks', 'price': -390}}, 'spread': {'home': {'name': 'Detroit Pistons', 'price': -110, 'point': 8.5}, 'away': {'name': 'Dallas Mavericks', 'price': -110, 'point': -8.5}}, 'totals': {'over': {'name': 'Over', 'price': -110, 'point': 218.5}, 'under': {'name': 'Under', 'price': -110, 'point': 218.5}}}}, {'league': 'mlb', 'pregame': True, 'inprogress': False, 'final': False, 'awayTeam': {'teamName': 'Nets', 'name': 'BKN', 'colors': {'main': [250, 250, 250], 'secondary': [255, 255, 255]}, 'record': '18-21'}, 'homeTeam': {'teamName': 'Knicks', 'name': 'NY', 'colors': {'main': [34, 94, 168], 'secondary': [245, 132, 38]}, 'record': '41-38'}, 'startTime': '7:30 PM EDT', 'weather': {'indoors': True, 'temp': 'undefined°'}, 'fanDuel': {'moneyLine': {'home': {'name': 'New York Knicks', 'price': 176}, 'away': {'name': 'Brooklyn Nets', 'price': -210}}, 'spread': {'home': {'name': 'New York Knicks', 'price': -110, 'point': 5}, 'away': {'name': 'Brooklyn Nets', 'price': -110, 'point': -5}}, 'totals': {'over': {'name': 'Over', 'price': -110, 'point': 229.5}, 'under': {'name': 'Under', 'price': -110, 'point': 229.5}}}}, {'league': 'mlb', 'pregame': True, 'inprogress': False, 'final': False, 'awayTeam': {'teamName': 'Wizards', 'name': 'WSH', 'colors': {'main': [14, 55, 100], 'secondary': [227, 24, 55]}, 'record': '21-19'}, 'homeTeam': {'teamName': 'Hawks', 'name': 'ATL', 'colors': {'main': [250, 250, 250], 'secondary': [250, 250, 250]}, 'record': '35-44'}, 'startTime': '8:00 PM EDT', 'weather': {'indoors': True, 'temp': 'undefined°'}, 'fanDuel': {'moneyLine': {'home': {'name': 'Atlanta Hawks', 'price': -590}, 'away': {'name': 'Washington Wizards', 'price': 410}}, 'spread': {'home': {'name': 'Atlanta Hawks', 'price': -110, 'point': -10.5}, 'away': {'name': 'Washington Wizards', 'price': -110, 'point': 10.5}}, 'totals': {'over': {'name': 'Over', 'price': -110, 'point': 234}, 'under': {'name': 'Under', 'price': -110, 'point': 234}}}}, {'league': 'mlb', 'pregame': True, 'inprogress': False, 'final': False, 'awayTeam': {'teamName': 'Celtics', 'name': 'BOS', 'colors': {'main': [250, 250, 250], 'secondary': [241, 242, 243]}, 'record': '28-13'}, 'homeTeam': {'teamName': 'Bulls', 'name': 'CHI', 'colors': {'main': [250, 250, 250], 'secondary': [250, 250, 250]}, 'record': '49-30'}, 'startTime': '8:00 PM EDT', 'weather': {'indoors': True, 'temp': 'undefined°'}, 'fanDuel': {'moneyLine': {'home': {'name': 'Chicago Bulls', 'price': 230}, 'away': {'name': 'Boston Celtics', 'price': -280}}, 'spread': {'home': {'name': 'Chicago Bulls', 'price': -110, 'point': 7}, 'away': {'name': 'Boston Celtics', 'price': -110, 'point': -7}}, 'totals': {'over': {'name': 'Over', 'price': -110, 'point': 224.5}, 'under': {'name': 'Under', 'price': -110, 'point': 224.5}}}}, {'league': 'mlb', 'pregame': True, 'inprogress': False, 'final': False, 'awayTeam': {'teamName': 'Thunder', 'name': 'OKC', 'colors': {'main': [198, 124, 3], 'secondary': [240, 81, 51]}, 'record': '12-29'}, 'homeTeam': {'teamName': 'Jazz', 'name': 'UTAH', 'colors': {'main': [6, 20, 63], 'secondary': [249, 160, 27]}, 'record': '24-55'}, 'startTime': '9:00 PM EDT', 'weather': {'indoors': True, 'temp': 'undefined°'}, 'fanDuel': {'moneyLine': {'home': {'name': 'Utah Jazz', 'price': -2200}, 'away': {'name': 'Oklahoma City Thunder', 'price': 1100}}, 'spread': {'home': {'name': 'Utah Jazz', 'price': -110, 'point': -17}, 'away': {'name': 'Oklahoma City Thunder', 'price': -110, 'point': 17}}, 'totals': {'over': {'name': 'Over', 'price': -110, 'point': 219}, 'under': {'name': 'Under', 'price': -110, 'point': 219}}}}, {'league': 'mlb', 'pregame': True, 'inprogress': False, 'final': False, 'awayTeam': {'teamName': 'Suns', 'name': 'PHX', 'colors': {'main': [35, 0, 106], 'secondary': [241, 242, 243]}, 'record': '32-8'}, 'homeTeam': {'teamName': 'Clippers', 'name': 'LAC', 'colors': {'main': [250, 0, 40], 'secondary': [241, 242, 243]}, 'record': '63-16'}, 'startTime': '10:00 PM EDT', 'weather': {'indoors': True, 'temp': 'undefined°'}, 'fanDuel': {'moneyLine': {'home': {'price': ''}, 'away': {'price': ''}}, 'spread': {'home': {'price': ''}, 'away': {'price': ''}}, 'totals': {'over': {'price': ''}, 'under': {'price': ''}}}}]
            print(responseArr)
            canvas = self.matrix
            ...
            for item in responseArr:
                ...
                if type(item) is dict and 'league' in item.keys() and item['league'] == 'mlb':
                    ...
                    if item['pregame'] == True:
                        ...
                        awaySpreadOddsPoints = graphics.DrawText(canvas, smallestFont, runningCount, 11, green, str(awaySpreadPointsString))
                        ...
                        overOddsPoints = graphics.DrawText(canvas, smallestFont, runningCount, 11, green, str(overTotalPointsString))
