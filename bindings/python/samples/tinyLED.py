                ...
                if type(item) is dict and 'league' in item.keys() and item['league'] == 'mlb':
                    ...
                    if item['pregame'] == True:
                        ...
                        while gameFinalRunning:
                            ...
                            pos -= 1
                            winningPitcher = graphics.DrawText(canvas, alilbiggerFont, pos, 32, green, "WP: {}".format(item['winningPitcher']))
                            losingPitcher = graphics.DrawText(canvas, alilbiggerFont, pos + 4 + winningPitcher, 32, red, "LP: {}".format(item['losingPitcher']))
