...
class RunText(SampleBase):
    ...
    def run(self):
        while True:
            ...
            responseArr = [{'league': 'mlb', 'pregame': False, 'inprogress': False, 'final': True, 'awayTeam': {'teamName': 'Phillies', 'name': 'PHI', 'score': '9', 'hits': {'name': 'hits', 'abbreviation': 'H', 'displayValue': '10'}, 'errors': {'name': 'errors', 'abbreviation': 'E', 'displayValue': '0'}, 'colors': {'main': [190, 0, 17], 'secondary': [40, 72, 152]}, 'record': '8-1'}, 'homeTeam': {'teamName': 'Rays', 'name': 'TB', 'score': '2', 'hits': {'name': 'hits', 'abbreviation': 'H', 'displayValue': '3'}, 'errors': {'name': 'errors', 'abbreviation': 'E', 'displayValue': '0'}, 'colors': {'main': [250, 250, 250], 'secondary': [143, 188, 230]}, 'record': '10-7'}, 'winningPitcher': 'R. Suarez 1-1', 'losingPitcher': 'L. Patino 1-1', 'finalDetail': 'Final'},{'league': 'nba', 'pregame': False, 'inprogress': False, 'final': True, 'awayTeam': {'teamName': 'Mavericks', 'name': 'DAL', 'score': '131', 'colors': {'main': [12, 71, 157], 'secondary': [196, 206, 211]}, 'record': '27-12'}, 'homeTeam': {'teamName': 'Pistons', 'name': 'DET', 'score': '113', 'colors': {'main': [250, 0, 44], 'secondary': [250, 250, 250]}, 'record': '50-30'}, 'winningPitcher': '', 'losingPitcher': '', 'finalDetail': 'Final'}, ['game inprogress nba', 'https://loodibee.com/wp-content/uploads/nba-brooklyn-nets-logo.png', 250, 250, 250, 'Brooklyn Nets', 'https://loodibee.com/wp-content/uploads/nba-new-york-knicks-logo.png', 34, 94, 168, 'New York Knicks', '6:35 ', '92', '95', '4th'], ['game inprogress nba', 'https://loodibee.com/wp-content/uploads/nba-washington-wizards-logo.png', 14, 55, 100, 'Washington Wizards', 'https://loodibee.com/wp-content/uploads/nba-atlanta-hawks-logo.png', 250, 250, 250, 'Atlanta Hawks', '10:47 ', '85', '95', '4th'], ['game inprogress nba', 'https://loodibee.com/wp-content/uploads/nba-boston-celtics-logo.png', 250, 250, 250, 'Boston Celtics', 'https://loodibee.com/wp-content/uploads/nba-chicago-bulls-logo.png', 250, 250, 250, 'Chicago Bulls', '2:29 ', '88', '62', '3rd'], ['game inprogress nba', 'https://loodibee.com/wp-content/uploads/nba-oklahoma-city-thunder-logo.png', 198, 124, 3, 'Oklahoma City Thunder', 'https://loodibee.com/wp-content/uploads/nba-utah-jazz-logo.png', 6, 20, 63, 'Utah Jazz', '8:12 ', '41', '52', '2nd'], {'league': 'nba', 'pregame': True, 'inprogress': False, 'final': False, 'awayTeam': {'teamName': 'Suns', 'name': 'PHX', 'colors': {'main': [35, 0, 106], 'secondary': [241, 242, 243]}, 'record': '32-8'}, 'homeTeam': {'teamName': 'Clippers', 'name': 'LAC', 'colors': {'main': [250, 0, 40], 'secondary': [241, 242, 243]}, 'record': '63-16'}, 'startTime': '10:15 PM EDT', 'weather': {'indoors': True, 'temp': 'undefined°'}, 'fanDuel': {'moneyLine': {'home': {'price': ''}, 'away': {'price': ''}}, 'spread': {'home': {'price': ''}, 'away': {'price': ''}}, 'totals': {'over': {'price': ''}, 'under': {'price': ''}}}}]
            print(responseArr)
            canvas = self.matrix
